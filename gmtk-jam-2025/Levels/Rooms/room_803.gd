...
@export var room_805: Node3D
@export var room_808: Node3D
...
func _on_area_3d_body_entered(body: Node3D) -> void:
	if body is CharacterBody3D:
		...
		room_805.global_position = global_position + Vector3(-10.0, 0.0, 0.0)
		room_808.global_position = global_position + Vector3(0.0, 0.0, -10.0)
